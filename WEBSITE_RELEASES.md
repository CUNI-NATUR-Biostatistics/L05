...
GitHub Pages must be configured once with **Source: GitHub Actions**. The `github-pages` environment must allow deployments from `main` and the lesson tag pattern `L05-v*`.
